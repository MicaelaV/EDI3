...
if (condition) {
	...
	$mailContact = $_POST['address'];
	$nameContact = $_POST['nombre'];
	$mensajeContact = $_POST['message'];
	...
	$mail->MsgHTML(utf8_decode("Hemos recibido una consulta de ".$nameContact.". Su cnsulta es ".$mensajeContact."<br> Sus datos de contacto son: ".$mailContact." y telefono ".$telContact));	
